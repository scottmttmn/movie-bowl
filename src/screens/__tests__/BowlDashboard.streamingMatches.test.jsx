...
describe("BowlDashboard streaming match count", () => {
  ...
  it("offers nothing to scan while streaming is not narrowing the draw", async () => {
    ...
    // With prioritization off, streaming changes nothing about the draw. The
    // old "Check your services" action could only ever appear in this state --
    // the one whose streaming readout this line does not show -- so tapping it
    // scanned, resolved, and then had nothing to display.
