...
- Starter packs: let an owner pour a named curated list into a bowl so a new
  ...
  **Design settled September 23, 2026; steps 1 and 2 of 4 built** (pack
  definitions, the live candidate resolver, and the schema and database
  functions; nothing visible yet). The pack's titles are
